...
We've just launched [SupPixel AI](suppixel.ai), a tool designed to help with high-quality image processing and upscaling. It builds on SUPIR, and incorporates some advanced AI technology to enhance image quality. Whether you’re into photography, digital art, or just love playing around with image enhancement, we’d love for you to check it out. Everyone gets free credit to use~
